...
export function getConfig(env) {
  return {
    ...
    maxPages: numberEnv(env.AIHOT_MAX_PAGES, 3, 1, 10),
    ...
    paperMaxPages: numberEnv(env.AIHOT_PAPER_MAX_PAGES, 3, 1, 10),
    paperMaxItems: numberEnv(env.AIHOT_PAPER_MAX_ITEMS, 5, 1, 10),
    minScore: numberEnv(env.AIHOT_MIN_SCORE, 60, 0, 100),
    bitableMaxRecords: numberEnv(env.AIHOT_BITABLE_MAX_RECORDS, 50, 1, 100),
